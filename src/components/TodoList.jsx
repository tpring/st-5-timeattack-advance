...
export default function TodoList() {
    ...
    const mutation = useMutation(async ({ id, liked }) => {
            ...
            {todos.map((todo) => (
                ...
                >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        {todo.liked ? (
                            <FaHeart onClick={() => handleLike(todo.id, todo.liked)} style={{ cursor: 'pointer' }} />
                        ) : (
                            <FaRegHeart onClick={() => handleLike(todo.id, todo.liked)} style={{ cursor: 'pointer' }} />
                        )}
                    </div>
                </li>
            ))}
